    ...
    class Chef
      ...
      def bootstrap
        ...
        if !@server.windows?
          ...
          kb.config[:msi_url] = "https://www.chef.io/chef/download?p=windows&pv=2012&m=x86_64&v=#{@config['groomer_version']}"
        ...
        ::Chef::Config[:knife][:bootstrap_version] = @config['groomer_version']
